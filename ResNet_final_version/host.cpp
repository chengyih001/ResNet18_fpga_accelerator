...
int main(int argc, char** argv) {
    ...
    //                                                                                     buffer_dummy}, 0));
    OCL_CHECK(err, err = queue.enqueueMigrateMemObjects({buffer_output_conv1, buffer_bn_weight_0, buffer_bn_weight_1_1, buffer_bn_weight_1_2, buffer_bn_weight_2_1, buffer_bn_weight_2_2, buffer_bn_weight_3_1, buffer_bn_weight_3_2, 
                                                                                    buffer_bn_weight_4_1, buffer_bn_weight_4_2, buffer_bn_weight_5_1, buffer_bn_weight_5_2, buffer_bn_weight_6_1, buffer_bn_weight_6_2,
                                                                                    buffer_bn_weight_7_1, buffer_bn_weight_7_2, buffer_bn_weight_8_1, buffer_bn_weight_8_2, buffer_bn_weight_9_1, buffer_bn_weight_9_2,
                                                                buffer_conv_bias_0, buffer_conv_bias_1_1, buffer_conv_bias_1_2, buffer_conv_bias_2_1, buffer_conv_bias_2_2, buffer_conv_bias_3_1, buffer_conv_bias_3_2,
                                                                                    buffer_conv_bias_4_1, buffer_conv_bias_4_2, buffer_conv_bias_5_1, buffer_conv_bias_5_2, buffer_conv_bias_6_1, buffer_conv_bias_6_2,
...
// layer 1
    ...
    // auto exec_time_2 = std::chrono::duration<double>(end_2 - start_2).count();
    ...
    // auto exec_time_3 = std::chrono::duration<double>(end_3 - start_3).count();
    ...
    // auto exec_time_4 = std::chrono::duration<double>(end_4 - start_4).count();
    ...
    // auto exec_time_5 = std::chrono::duration<double>(end_5 - start_5).count();
    ...
    // auto exec_time_6 = std::chrono::duration<double>(end_6 - start_6).count();
    ...
    // auto exec_time_7 = std::chrono::duration<double>(end_7 - start_7).count();
...
// layer 9
    ...
    // printf("FPGA kernel exec time 1 is %f s\n", exec_time);
    // printf("FPGA kernel exec time 2 is %f s\n", exec_time_2);
    // printf("FPGA kernel exec time 3 is %f s\n", exec_time_3);
    // printf("FPGA kernel exec time 4 is %f s\n", exec_time_4);
    // printf("FPGA kernel exec time 5 is %f s\n", exec_time_5);
    // printf("FPGA kernel exec time 6 is %f s\n", exec_time_6);
    // printf("FPGA kernel exec time 7 is %f s\n", exec_time_7);
